...
BEGIN
	...
	(RecipeName, 3, 3, INTERVAL '4 HOURS', 
		'[
			"Prepare 2 bowls, one with beaten ${quantity::\\{\"amount\": 1.00000000, \"quality\": \"Large\", \"name\": \"egg\"\\}}, and the second with ${quantity::\\{\"amount\": 2.0, \"units\": [\"Tablespoon\", \"Tablespoons\"], \"name\": \"corn starch\"\\}} mixed with a pinch of salt and pepper.",
			"Dip the ${quantity::\\{\"amount\": 4.0, \"units\": [\"Breast\", \"Breasts\"], \"name\": \"chicken\"\\}} into the beaten egg. Place all the pieces into the cornstarch and toss to lightly and evenly coat.",
			"Heat the ${quantity::\\{\"amount\": 1.0, \"units\": [\"Teaspoon\", \"Teaspoons\"], \"name\": \"oil\"\\}} in a non-stick skillet over medium heat. Add the chicken pieces in a single layer without overlapping.",
