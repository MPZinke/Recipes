...
BEGIN
	...
	(RecipeName, 4, 4, INTERVAL '10 MINUTES', INTERVAL '50 MINUTES', INTERVAL '1 HOURS',
		...
		'[
			...
			"Brown green onion tips, and any remaining pepper tops in the oil for {{ timer(minutes=1) }}-{{ timer(minutes=2) }} minutes.",
			"Add your ground turkey or beef, and cook until browned through, about {{ timer(minutes=5) }}-{{ timer(minutes=7) }}.",
